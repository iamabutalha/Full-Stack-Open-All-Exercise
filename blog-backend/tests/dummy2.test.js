...
describe("Blogs", () => {
  test("sohuld return 1", () => {
    expect(dummy(1)).toBe(1);
  });

  test("return total blog count", () => {
    ...
    expect(totalLikesCounter(listWithOneBlog[0])).toBe(5);
  });
  ...
  test("of author with most blogs", () => {
    ...
    expect(mostBlog(listWithOneBlog)).toEqual({
      author: "Robert C. Martin",
      blogs: 3,
    });
  });

  test("return likes of author with highest number if likes", () => {
    const listWithOneBlog = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
